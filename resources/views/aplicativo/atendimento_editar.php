	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo URL::base(true).'aplicativo/atendimento/'; ?>">Atendimento</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="#">Editar Departamento</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'aplicativo/atendimentoEdit/'.$coddep.'/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Editar Departamento </span>
								</div>
								<div class="actions btn-set">
									<a type="button" class="btn btn-default btn-circle" href="<?php echo URL::base(true).'aplicativo/atendimento/'?>"><i class="fa fa-angle-left"></i> Voltar</a>
										...
										<div class="tab-pane active" id="tab_general">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" required name="departamento" required placeholder="Ex: Vendas" value="<?php echo $departamento; ?>">
														<input type="hidden" name="coddep" value="<?php echo $coddep; ?>" />
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-2 control-label">E-mail: <span class="required"> * </span>
													</label>
													<div class="col-md-10">
														<input type="email" class="form-control" required name="email" placeholder="email@dominio.com.br" value="<?php echo $email; ?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-2 control-label">Senha de acesso ao chat: <span class="required"> * </span>
													</label>
													<div class="col-md-10">
														<input type="password" class="form-control" required name="senha" value="<?php echo $senha; ?>">
													</div>
												</div>
											</div>
										</div>
