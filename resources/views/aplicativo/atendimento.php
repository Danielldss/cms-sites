						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<a href="<?php echo URL::base(true).'aplicativo/atendimentoNew/';?>" class="btn btn-sm blue"><i class="fa fa-plus"></i> Adicionar</a>
								</div>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-atendimento.js"></script>
...
<script>
        jQuery(document).ready(function() {
           	...
           	EcommerceAtendimento.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
