		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Novo Sorteio <small>Criar Departamento</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'aplicativo/atendimentoNew/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Novo Departamento </span>
								</div>
										...
										<div class="tab-pane active" id="tab_general">
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" required name="departamento" required placeholder="Ex: Vendas">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="email" class="form-control" required name="email" placeholder="email@dominio.com.br">
													</div>
												</div>
												<div class="form-group">
