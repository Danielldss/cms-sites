		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Sorteios <small>Listagem</small></h1>
				</div>
				<!-- END PAGE TITLE -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Sorteios</span>
								<span class="caption-helper">listagem de variacoes...</span>
							</div>
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<a href="<?php echo URL::base(true).'aplicativo/sorteioNew/';?>" class="btn btn-sm blue"><i class="fa fa-plus"></i> Adicionar</a>
								</div>
								...
								<tr role="row" class="filter">
									<td></td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="codsorteio">
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="sorteio">
									</td>
									<td></td>
									<td></td>
									<td></td>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-sorteios.js"></script>
...
<script>
        jQuery(document).ready(function() {
           	...
           	EcommerceSorteios.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
