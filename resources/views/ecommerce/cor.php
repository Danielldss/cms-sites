		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Cor <small>Listagem</small></h1>
				</div>
				<!-- END PAGE TITLE -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Cor</span>
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<a href="<?php echo URL::base(true).'ecommerce/corNew/';?>" class="btn btn-sm blue"><i class="fa fa-plus"></i> Adicionar</a>
								</div>
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="codcor">
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="cor">
									</td>
									<td>
									</td>
									<td>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-cor.js"></script>
...
<script>
        jQuery(document).ready(function() {
           	...
           	EcommerceCor.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
