		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Categorias <small>Listagem</small></h1>
				</div>
				<!-- END PAGE TITLE -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-helper">listagem de categorias...</span>
							</div>
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<a href="<?php echo URL::base(true).'ecommerce/categoriaNew/';?>" class="btn btn-sm blue"><i class="fa fa-plus"></i> Adicionar</a>
								</div>
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="codcategoria">
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="categoria">
									</td>
									<td>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-categorias.js"></script>
...
<script>
        jQuery(document).ready(function() {
			...
			Demo.init(); // init demo features
           	EcommerceCategorias.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
