		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Editar Variação <small>Criar variação</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'ecommerce/variacaoEdit/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Editar Variação </span>
								</div>
								<div class="actions btn-set">
									<a type="button" class="btn btn-default btn-circle" href="<?php echo URL::base(true).'ecommerce/variacoes/'?>"><i class="fa fa-angle-left"></i> Voltar</a>
										...
										<div class="tab-pane active" id="tab_general">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-2 control-label">Variação: <span class="required">
													* </span>
													</label>
													<div class="col-md-10">
														<input type="text" class="form-control" name="variacao" required value="<?php echo $variacao; ?>">
														<input type="hidden" name="codvariacao" value="<?php echo $codvariacao; ?>" />
													</div>
												</div>
											</div>
										</div>
