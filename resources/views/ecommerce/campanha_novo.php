		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Nova Campanha <small>Criar campanha</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'ecommerce/campanhaNew/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Nova Campanha </span>
								</div>
										...
										<div class="tab-pane active" id="tab_general">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-2 control-label">Campanha:
													</label>
													<div class="col-md-10">
														<input type="text" class="form-control" name="promocao" required placeholder="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-2 control-label">Cód. Cupom:
													</label>
													<div class="col-md-10">
														<input type="text" class="form-control" name="cupom" required placeholder="">
													</div>
												</div>
												...
												<div class="form-group hidden" id="valor">
													<label class="col-md-2 control-label">Valor
													</label>
													<div class="col-md-10">
														<input type="text" class="form-control" name="valor"  data-mask="decimal">
													</div>
												</div>
												<div class="form-group hidden" id="qtdprodutos">
													<label class="col-md-2 control-label">Quantidade de produtos
													</label>
													<div class="col-md-10">
														<input type="text" class="form-control" name="qtdprodutos" data-mask="numerico">
													</div>
												</div>
												<div class="form-group hidden" id="porcentagem">
													<label class="col-md-2 control-label">% de desconto
													</label>
													<div class="col-md-10">
														<input type="text" class="form-control" name="porcentagem" data-mask="numerico">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" name="dtvalidade" data-mask="date" required >
													</div>
												</div>
												<div class="form-group">
