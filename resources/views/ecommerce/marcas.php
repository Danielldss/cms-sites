					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Marcas</span>
								<span class="caption-helper">listagem de marcas...</span>
							</div>
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<a href="<?php echo URL::base(true).'ecommerce/marcaNew/';?>" class="btn btn-sm blue"><i class="fa fa-plus"></i> Adicionar</a>
								</div>
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="codmarca">
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="marca">
									</td>
									<td>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-marcas.js"></script>
...
<script>
        jQuery(document).ready(function() {
           	...
           	EcommerceMarcas.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
