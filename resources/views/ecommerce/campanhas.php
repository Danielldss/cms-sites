		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Campanhas <small>Listagem de campanhas</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			<!-- END PAGE HEAD -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Campanhas</span>
								<span class="caption-helper">Gerenciar campanhas...</span>
							</div>
							<div class="actions">
								<div class="btn-group">
									<a class="btn btn-sm blue" href="<?php echo URL::base(true).'ecommerce/campanhaNew/';?>">
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="cupom">
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="promocao">
									</td>
									<td>
									</td>
									<td>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-campanhas.js"></script>
