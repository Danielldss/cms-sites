    ...
    <div class="page-content">
      ...
      <div class="page-head">
        ...
        <div class="page-title">
          <h1>PEDIDO <small>editar pedido</small></h1>
        </div>
        <!-- END PAGE TITLE -->
      ...
      <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
          <a href="<?php echo URL::base(true).'ecommerce/pedidos/'; ?>">Pedidos</a>
          <i class="fa fa-circle"></i>
        </li>
        <li>
          <a href="#">PEDIDO <?php echo $numpedido; ?></a>
        </li>
      </ul>
      <!-- END PAGE BREADCRUMB -->
      <!-- END PAGE HEADER-->
            ...
            <div class="portlet light">
              <div class="portlet-title">
                <div class="caption">
                  ...
                  <span class="caption-subject font-green-sharp bold uppercase">Pedido </span>
                </div>
                <div class="actions btn-set">
                  <a type="button" class="btn btn-default btn-circle" href="<?php echo URL::base(true).'ecommerce/pedidos/'; ?>"><i class="fa fa-angle-left"></i> Voltar</a>
                </div>
                                <div class="actions btn-set">
                                    <a type="button" class="btn btn-default btn-circle" target="_blank" href="<?php echo URL::base(true).'ecommerce/pedidoImprimir/'.$corpedido; ?>"><i class="fa fa-print"></i> Imprimir</a>
                                </div>
              ...
              <div class="portlet-body">
                <div class="tabbable">
                  <ul class="nav nav-tabs">
                    <li class="active">
                      <a href="#tab_pedidos" data-toggle="tab">Pedido</a>
                    </li>
                    <li>
                      <a href="#tab_general" data-toggle="tab">Usuário</a>
                    </li>
                  </ul>
                  <div class="tab-content no-space">
                    <!--  PEDIDOS  -->
                    <div class="tab-pane active" id="tab_pedidos">
                      <!--  repeat -->
                      <?php echo $pedidos; ?>
                    </div>
                    <div class="tab-pane" id="tab_general">
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          <label class="col-md-1 control-label">Endereço:
                          </label>
                          <div class="col-md-11">
                            <input type="text" class="form-control" value="<?php echo $endereco.', '.$numero; ?>" placeholder="" disabled="disabled">
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="col-md-1 control-label">Complemento:
                          </label>
                          <div class="col-md-11">
                            <input type="text" class="form-control" value="<?php echo $complemento; ?>" placeholder="" disabled="disabled">
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="col-md-1 control-label">Bairro:
                          </label>
                          <div class="col-md-11">
                            <input type="text" class="form-control" value="<?php echo $bairro; ?>" placeholder="" disabled="disabled">
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="col-md-1 control-label">Cidade / Estado:
                          </label>
                          <div class="col-md-11">
                            <input type="text" class="form-control" value="<?php echo $cidade.' - '.$estado; ?>" placeholder="" disabled="disabled">
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="col-md-1 control-label">CEP:
                          </label>
                          <div class="col-md-11">
                            <input type="text" class="form-control" value="<?php echo $cep; ?>" placeholder="" disabled="disabled">
                          </div>
                        </div>
                      </div>
                    </div>
