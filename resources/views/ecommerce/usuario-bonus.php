				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							...
							<div class="actions">
								<div class="btn-group">
									<a class="btn btn-sm blue" href="<?php echo URL::base(true).'ecommerce/adicionarBonus/'.$codusu; ?>">
									<i class="fa fa-plus"></i> Adicionar Bônus</a>
								</div>

								<div class="btn-group">
									<a class="btn btn-sm red" href="<?php echo URL::base(true).'ecommerce/debitarBonus/'.$codusu; ?>">
									<i class="fa fa-minus"></i> Debitar Bônus</a>
								</div>
							</div>
						</div>
