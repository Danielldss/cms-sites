		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Editar Departamento <small>Criar departamento</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'ecommerce/departamentoEdit/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								...
								<div class="actions btn-set">
									<a type="button" class="btn btn-default btn-circle" href="<?php echo URL::base(true).'ecommerce/departamentos/'?>"><i class="fa fa-angle-left"></i> Voltar</a>
											...
											<div class="form-body">
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-10">
														<input type="text" class="form-control" name="departamento" required value="<?php echo $departamento; ?>">
