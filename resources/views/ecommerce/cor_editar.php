		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Editar Cor <small>Criar cor</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'ecommerce/corEdit/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Editar Cor </span>
								</div>
										...
										<div class="tab-pane active" id="tab_general">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-2 control-label">Nome da cor: <span class="required">
													* </span>
													</label>
													<div class="col-md-10">
														<input type="text" class="form-control" name="cor" required value="<?php echo $cor; ?>">
														<input type="hidden" name="codcor" value="<?php echo $codcor; ?>" />
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-2 control-label">Cor: <span class="required">
													* </span>
													</label>
													<div class="col-md-10">
														<input type="color" class="form-control" value="<?php echo $valor; ?>" name="valor" required>
													</div>
												</div>
											</div>
										</div>
