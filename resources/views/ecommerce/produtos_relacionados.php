		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Relacionar produtos <small>Listagem de produtos</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo URL::base(true).'ecommerce/produtos/'; ?>">Produtos</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="#">Relacionar produtos</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
					...
					<div class="portlet light">
						<div class="portlet-title">
							...
							<div class="actions btn-set">
								<a type="button" class="btn btn-default btn-circle" href="<?php echo URL::base(true).'ecommerce/produtoEdit/'.$codproduto; ?>"><i class="fa fa-angle-left"></i> Voltar</a>
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="refproduto">
									</td>
									<td>

									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="produto">
									</td>
									...
									<td>
										<select name="status" class="form-control form-filter input-sm">
											...
											<option value="S">Adicionados</option>
										</select>
									</td>
									<td>
...
jQuery(document).ready(function() {
	...
	EcommerceProductsRelacionados.init(<?php echo $codproduto; ?>, '<?php echo URL::base(true); ?>');
});
</script>
<!-- END JAVASCRIPTS -->
</body>
