		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Novo Sorteio <small>Criar Sorteio</small></h1>
				</div>
				<!-- END PAGE TITLE -->
						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="caption-subject font-green-sharp bold uppercase">Novo Sorteio </span>
								</div>
										...
										<div class="tab-pane active" id="tab_general">
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" required name="titulo" required placeholder="Ex: Quer ganhar esse prêmio?">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" required name="dtinicio" data-mask="date" placeholder="<?php echo '01/'.date('m/Y'); ?>">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" required name="dtfinal" data-mask="date" placeholder="<?php echo '30/'.date('m/Y'); ?>">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" required name="produto" placeholder="Ex: Par de tênis nike">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" class="form-control" name="valor" required data-mask="decimal">
													</div>
												</div>
												<div class="form-group">
