		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Adicionar produto a campanha <small>Listagem de produtos</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="#">Adicionar produto a campanha</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
...
jQuery(document).ready(function() {
	...
	EcommerceProductsPromo.init('<?php echo $codpromo; ?>', '<?php echo URL::base(true); ?>');
});
</script>
<!-- END JAVASCRIPTS -->
</body>
