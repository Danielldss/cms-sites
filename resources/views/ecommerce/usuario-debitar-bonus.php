	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 margin-bottom-10">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-green-sharp"><small class="font-green-sharp">R$</small> <?php echo $bonus; ?></h3>
								<small>BÔNUS ACUMULADOS</small>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-red-haze"><small class="font-red-haze">R$</small> <?php echo $bonusDebitados; ?></h3>
								<small>BÔNUS DEBITADOS</small>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<?php echo $retorno; ?>
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" id="frmusuario" method="post" action="<?php echo URL::base(true).'ecommerce/debitarBonus/'.$codusu.'/'; ?>" enctype="multipart/form-data">
									...
									<div class="tab-content no-space">
										<div class="form-body">
											<div class="form-group">
												...
												<label class="col-md-2 control-label">Utilizar valor de bônus:</label>
												<div class="col-md-2">
													<input type="text" class="form-control" data-mask="decimal" id="valbonus" name="valbonus" placeholder="0,00">
												</div>
											</div>
										</div>
									</div>
