		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Nova Variação <small>Criar variação</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'ecommerce/variacaoNew/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Nova Variação </span>
								</div>
											...
											<div class="form-body">
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-10">
														<input type="text" class="form-control" name="variacao" required placeholder="Ex: Tamanho">
													</div>
												</div>
											</div>
										</div>
