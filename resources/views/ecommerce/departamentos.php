		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Departamentos <small>Listagem</small></h1>
				</div>
				<!-- END PAGE TITLE -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Departamentos</span>
								<span class="caption-helper">listagem de departamentos...</span>
							</div>
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<a href="<?php echo URL::base(true).'ecommerce/departamentoNew/';?>" class="btn btn-sm blue"><i class="fa fa-plus"></i> Adicionar</a>
								</div>
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="coddep">
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="departamento">
									</td>
									<td>
									...
									<td>
										<div class="margin-bottom-5">
											<button class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-search"></i> Busca</button>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-departamentos.js"></script>
...
<script>
        jQuery(document).ready(function() {
			...
			Demo.init(); // init demo features
           	EcommerceDepartamentos.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
