	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo URL::base(true).'usuario/listausuarios/'; ?>">Usuários</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box yellow">
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo URL::base(); ?>usuario/editausuario/<?php echo $codconta.'/'.$codusu.'/'; ?>" method="post" class="form-horizontal">
											<div class="form-actions top">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="submit" class="btn green">Salvar</button>
														<a href="<?php echo URL::base(true).'usuario/listausuarios/'; ?>" class="btn default">Listagem</a>
													</div>
												</div>
											</div>
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="acesso">
															...
															<option value="F" <?php echo $func; ?>>Funcionário</option>
														</select>
													</div>
												</div>
											</div>
