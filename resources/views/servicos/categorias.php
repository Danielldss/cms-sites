						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<a href="<?php echo URL::base(true).'servicos/categoriaNew/';?>" class="btn btn-sm blue"><i class="fa fa-plus"></i> Adicionar</a>
								</div>
...
<script>
        jQuery(document).ready(function() {
			...
			ServicoCategorias.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
