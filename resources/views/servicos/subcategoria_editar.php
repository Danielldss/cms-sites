	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo URL::base(true).'subcategorias/'; ?>">Serviços | Subcategorias</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="#">Editar Subcategoria</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'servicos/subcategoriaEdit/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Editar Subcategoria </span>
								</div>
											...
											<div class="form-body">
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-10">
														<input type="text" class="form-control" name="subcategoria" value="<?php echo $subcategoria; ?>" required>
														<input type="hidden" name="codsubcategoria" value="<?php echo $codsubcategoria; ?>" required>
													</div>
												</div>
												<div class="form-group">
