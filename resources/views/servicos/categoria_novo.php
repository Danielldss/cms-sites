...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="<?php echo URL::base(true).'servicos/categoriaNew/'; ?>" enctype="multipart/form-data">
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Nova Categoria </span>
								</div>
											...
											<div class="form-body">
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-10">
														<input type="text" class="form-control" name="categoria" required placeholder="">
													</div>
												</div>
