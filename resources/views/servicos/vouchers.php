		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Voucher <small>Listagem de cupons</small></h1>
				</div>
				<!-- END PAGE TITLE -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Vouchers</span>
								<span class="caption-helper">Gerenciar vouchers...</span>
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									<td></td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="voucher">
									</td>
									<td></td>
									<td></td>
									<td></td>
...
<script src="<?php echo URL::base(true); ?>assets/admin/pages/scripts/ecommerce-vouchers.js"></script>
<script src="<?php echo URL::base(true); ?>assets/global/scripts/meiomask.js"></script>
...
<script>
        jQuery(document).ready(function() {
			...
			EcommerceVouchers.init('<?php echo URL::base(true); ?>');
        });
    </script>
<!-- END JAVASCRIPTS -->
</body>
