	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo URL::base(true).'servicos/'; ?>">E-commerce</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="#">Serviços</a>
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" id="frmservico" method="post" action="<?php echo URL::base(true).'servicos/servicoEdit/'.$codservico.'/'; ?>" enctype="multipart/form-data">
						<input type="hidden" value="<?php echo $codservico; ?>" name="codservico" id="codservico"/>
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-basket font-green-sharp"></i>
									<span class="caption-subject font-green-sharp bold uppercase">Serviço </span>
								</div>
								<div class="actions btn-set">
									<a class="btn btn-sm blue btn-circle" href="<?php echo URL::base(true); ?>servicos/servicoNew/"><i class="fa fa-plus"></i> Adicionar</a>
									<a type="button" class="btn btn-default btn-circle" href="<?php echo URL::base(true).'servicos/servicoCancel/'.$codservico; ?>"><i class="fa fa-angle-left"></i>  Excluir</a>
							...
							<div class="portlet-body">
								<div class="tabbable">
									<ul class="nav nav-tabs">
										...
										<li>
											<a href="<?php echo URL::base(true).'servicos/servicoAvaliacoes/'.$codservico.'/'; ?>">Avaliações</a>
										</li>
									</ul>
									<div class="tab-content no-space">
										<div class="tab-pane active" id="tab_general">
											<div class="form-body">
												...
												<div class="form-group">
													<label class="col-md-2 control-label">Desconto:
													</label>
													<div class="col-md-10">
												...
												<div class="form-group">
													<label class="col-md-2 control-label">Categorias / Sub Categorias:
													</label>
													<div class="col-md-10">
...
function avaliacoes(){
	$('#tableAvaliacoes').load("<?php echo URL::base(true).'servicos/servicoListAvaliacoes/'.$codservico; ?>");
}
